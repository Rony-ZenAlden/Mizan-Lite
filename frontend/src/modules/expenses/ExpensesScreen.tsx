...
import { expenses, unsettledExpenses, type Expense } from "@/lib/wails";
    ...
    <section className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <header className="flex flex-col gap-1">
          <h2 className="text-base font-medium text-text">{t("expenses.title")}</h2>
          <p className="text-sm text-text-muted">{t("expenses.help")}</p>
        </header>
      ...
      <div className="flex flex-col gap-4">
        <header className="flex flex-col gap-1">
          <h2 className="text-base font-medium text-text">{t("expenses.owed")}</h2>
          <p className="text-sm text-text-muted">{t("expenses.owedHelp")}</p>
        </header>
