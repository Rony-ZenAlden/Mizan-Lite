...
// Verify checks every sale against itself and against the stock that moved with it (L4 §8.3). sales carry their
// lines; local and usd are the two currencies' decimals.
func Verify(sales []Sale, movements []StockMovement, local, usd Currency) []Finding {
	var out []Finding
